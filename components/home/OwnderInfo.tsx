  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="text-center md:text-start mb-6">
            ...
            <p className="text-[0.8rem] font-bold">
              Founder and CEO, The Earn Way Academy
            </p>
          </div>
        </div>
      </div>
      <div className="w-full lg:w-[50%]  md:px-8">
        ...
        <div>
          <p className=" text-[0.9rem] leading-6 text-justify  bangla_font">
            ...
            পৃথিবী যখন প্রযুক্তির দিকে এগিয়ে যাচ্ছে সেখানে আমাদের সোনার বাংলা
            পিছিয়ে থাকার কোন সুযোগ নেই। উন্নত দেশগুলিতে মানুষ ঘরে বসেই অনলাইনে
            আউটসোসিং এর মাধ্যমে লক্ষ লক্ষ টাকা উপার্জন করে যাচ্ছে। কিন্তু আমাদের
            দেশে তৃর্ণমুল পর্যায়ে এখনও প্রত্যাশিতভাবে কম্পিউটার শিক্ষা চালু
            হয়নি। আমরা প্রতিটি জেলা ও থানা পর্যায়ে একটি করে আধুনিক কম্পিউার
            ট্রেনিং সেন্টার চালু করার উগ্যোগ গ্রহণ করেছি। দেশ থেকে বেকারত্ব দুর
            করা সকলের দায়িত্ব শুধু সরকারেরই নয়। আমরা কর্মসংস্থানের সুযোগ সৃষ্টির
